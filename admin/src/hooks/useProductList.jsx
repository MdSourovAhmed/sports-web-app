...
//     setLoading(true);
//     try {
//       const res = await api.get(`${backendUrl}/api/admin/product/list`);
//       if (res.data?.product) {
//         setList(res.data.product);
//         setFilteredList(res.data.product);
//       } else {
//         setList([]);
//         setFilteredList([]);
//       }
...
//     try {
//       const res = await api.delete(`${backendUrl}/api/admin/product/remove/${id}`);
//       if (res.data?.success) {
...
//           api.delete(`${backendUrl}/api/product/remove/${id}`)
//         )
//       );
