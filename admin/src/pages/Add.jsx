...
// const Add = () => {
//   return (
//     <form action="" className="flex flex-col items-start gap-3 w-full">
//       <div className="">
//         <p className="mb-4" >Upload Images</p>
...
//         <textarea type="text" className="w-full max-w-[500px] px-3 py-2 " placeholder="Type here" required/>
//       </div>
//       <div>
//         <div>
